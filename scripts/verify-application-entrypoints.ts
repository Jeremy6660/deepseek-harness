...
/** Public product launcher plus explicitly classified private build tools. */
const MANIFEST_BIN_ALLOWLIST = new Map<string, ManifestBin>([
  ['apps/cli/package.json', { dsh: 'lib/bin.js' }],
  ['apps/portable/package.json', { 'dsh-portable': 'lib/cli.js' }],
...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['apps/portable/src/cli.ts', 'private distribution build tool'],
