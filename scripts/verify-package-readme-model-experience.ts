...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-brand-product': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
  ...
  'packages/bundle/consumer-web': { kind: 'indirect', reason: 'The bundle is a patch-list carrier over dsh-web-app; its brand row is browser presentation and its disabled rows are model-agnostic developer surfaces.' },
