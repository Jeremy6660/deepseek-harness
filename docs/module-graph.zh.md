...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_brand_product["client-ui-brand-product"]
...
| [`consumer-web`](../packages/bundle/consumer-web) | `bundle` | — |
...
| [`client-ui-brand-product`](../packages/client/ui-brand-product) | `client` | — |
